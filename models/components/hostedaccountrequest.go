...
// HostedAccountRequest - __Conditional__. Used to further specify details of the `Consent` to request
//
// Conditions:
//
...
type HostedAccountRequest struct {
...
func (h HostedAccountRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(h, "", false)
}

func (h *HostedAccountRequest) UnmarshalJSON(data []byte) error {
...
func (h *HostedAccountRequest) GetTransactionFrom() *time.Time {
	if h == nil {
		return nil
	}
...
func (h *HostedAccountRequest) GetTransactionTo() *time.Time {
	if h == nil {
		return nil
	}
...
func (h *HostedAccountRequest) GetExpiresAt() *time.Time {
	if h == nil {
		return nil
	}
	return h.ExpiresAt
...
func (h *HostedAccountRequest) GetFeatureScope() []FeatureEnum {
	if h == nil {
		return nil
	}
