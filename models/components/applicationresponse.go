...
type ApplicationResponse struct {
	...
	RootApplicationID *string `json:"rootApplicationId,omitzero"`
	...
	// - MEDICAL
	// - PENSIONS
	PpcUserGroup *string `json:"ppcUserGroup,omitzero"`
	// The application callback URLs
	CallbackUrls []string `json:"callbackUrls,omitzero"`
	// Indicates if a contract is in place with the merchant and a KYB process has been completed
	IsContractPresent *bool `json:"isContractPresent,omitzero"`
}
...
func (a *ApplicationResponse) GetID() *string {
	if a == nil {
		return nil
	}
	return a.ID
...
func (a *ApplicationResponse) GetRootApplicationID() *string {
	if a == nil {
		return nil
	}
	return a.RootApplicationID
}

func (a *ApplicationResponse) GetName() *string {
	if a == nil {
		return nil
	}
	return a.Name
...
func (a *ApplicationResponse) GetMerchantCategoryCode() *string {
	if a == nil {
		return nil
	}
...
func (a *ApplicationResponse) GetPpcUserGroup() *string {
	if a == nil {
		return nil
	}
	return a.PpcUserGroup
}

func (a *ApplicationResponse) GetCallbackUrls() []string {
	if a == nil {
		return nil
	}
	return a.CallbackUrls
}

func (a *ApplicationResponse) GetIsContractPresent() *bool {
	if a == nil {
		return nil
	}
	return a.IsContractPresent
}
