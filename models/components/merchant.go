...
// Merchant - Details of the merchant involved in the transaction.
type Merchant struct {
	// The name of the merchant involved in the transaction.
	MerchantName *string `json:"merchantName,omitzero"`
	// Defines the underlying services and goods that the merchant provides. Specified as a 4-letter ISO 18245 code.
	//
	// Allowed values:
	//
...
func (m *Merchant) GetMerchantCategoryCode() *string {
	if m == nil {
		return nil
	}
