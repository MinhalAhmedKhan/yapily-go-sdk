...
// Payee - __Mandatory__. Details of the beneficiary [person or business].
type Payee struct {
	...
	// __Optional__. The category code of the merchant in case the `Payee` is a business. Specified as a 4-letter ISO 18245 code.
	//
	// Allowed values:
	//
...
func (p Payee) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *Payee) UnmarshalJSON(data []byte) error {
...
func (p *Payee) GetAccountIdentifications() []AccountIdentification {
	if p == nil {
...
func (p *Payee) GetAccountType() *string {
	if p == nil {
		return nil
	}
...
func (p *Payee) GetAddress() *Address {
	if p == nil {
		return nil
	}
	return p.Address
...
func (p *Payee) GetMerchantID() *string {
	if p == nil {
		return nil
	}
	return p.MerchantID
...
func (p *Payee) GetMerchantCategoryCode() *string {
	if p == nil {
		return nil
	}
